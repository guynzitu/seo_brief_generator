...
with st.sidebar:
    ...
    include_internal_linking = st.checkbox(
        "Maillage interne",
        value=True,
        help="Propose des liens internes : ancre + lien vers une page existante "
             "du site cible, ou ancre seule à créer si la page n'existe pas encore."
    )
...
with tab_single:
    ...
    if st.session_state.briefs:
        ...
        if il and il.get("links"):
            st.markdown("### 🔗 Maillage interne recommandé")
